...
- [ ] main.go - parsing user input and core copy logic
    - [ ] parse CLI flags and arguments
    - [ ] discover fields on source and destination projects
    - [ ] define a mapping between fields on the source and destination
    - [ ] copy items between projects
- [ ] github.go - library functions that wrap API calls to GitHub
    - [ ] **Project Discovery**: Query projects by name or number
    - [ ] **Item Retrieval**: Fetch project items with field values
...
1. **Permission Errors**
   - [ ] Insufficient permissions on source or destination project
...
### Error Recovery
- [ ] **Partial failure handling**: Continue copying other items when individual items fail
- [ ] **Resume functionality**: Resume interrupted copy operations
- [x] **Detailed error reporting**: Log specific failures with actionable error messages
